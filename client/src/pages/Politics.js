	...
	return (
		<main className='main'>
			<div className='politics container'>
				<div className='politics-point'>
					<h2 className='politics-title medium-title'>1. Общие положения</h2>
					<p className='politics-text text'>
						...
						Серайждин Элдеров Дзебраилович (далее — Оператор).
					</p>
					<ul className='points'>
						<li className='point'>
						...
						<li className='point'>
							...
							веб-сайта http://vinil-record.
						</li>
					</ul>
				</div>
				<div className='politics-point'>
					<h2 className='politics-title medium-title'>
				...
				<div className='politics-point'>
					...
					<ul className='points'>
						...
						<li className='point'>
							Персональные данные: электронный адрес, номера телефонов
						</li>
						<li className='point'>
						...
						<li className='point'>
							Виды обработки персональных данных: Отправка информационных писем
				...
				<div className='politics-point'>
					...
					<ul className='points'>
						...
						<li className='point'>
							...
							Оператора vinil-record@gmail.com с пометкой «Актуализация
							персональных данных».
						</li>
						<li className='point'>
							...
							vinil-record@gmail.com с пометкой «Отзыв согласия на обработку
							персональных данных».
						</li>
						<li className='point'>
				...
				<div className='politics-point'>
					...
					<ul className='points'>
						...
						<li className='point'>
							...
							сети Интернет по адресу https://vinil-record/politics.
						</li>
					</ul>
				</div>
			</div>
